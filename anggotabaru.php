                    ...
                    <div class="col-lg-12">
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h3 class="panel-title">Data Pribadi Anggota</h3>
							</div>
							<div class="panel-body">
								<form class="form col-lg-12" method="POST" action="client-insert-anggota.php">
									<div class="form-group">
										<label>Nama Lengkap</label>
										<input name="nama" class="form-control" placeholder="Enter text">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input name="alamat" class="form-control" placeholder="Enter text">
									</div>
									<div class="form-group">
										<label>Nomor Telepone/Handphone</label>
										<input name="noTelp" class="form-control" placeholder="Enter text">
									</div>
									<div class="form-group">
										<label>Jenis ID</label>
										<select name="jId" class="form-control">
											<option>Kartu Tanda Penduduk</option>
											<option>Kartu Tanda Pelajar/Mahasiswa</option>
									...
									<div class="form-group">
										...
										<input name="noId" class="form-control" placeholder="Enter text">
									</div>
									<div class="form-group">
